...
namespace Vishcious.ArcGIS.SLContrib
{
    public class GPXLayer : GraphicsLayer
    {
        ...
        private Dictionary<string, object> LoadTrackAttributes( trkType trk, Dictionary<string, object> attributes )
        {
        ...
        private Dictionary<string, object> LoadRouteAttributes( rteType rte, Dictionary<string, object> attributes )
        {
        ...
        private Dictionary<string, object> LoadWayPointAttributes( wptType wpt, Dictionary<string, object> attributes )
        {
