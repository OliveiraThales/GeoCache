...
namespace Vishcious.ArcGIS.SLContrib
{
    public class PngEncoder
    {
        ...
        private void PrepareBuffer( int width, int height )
        {
            ...
            _buffer[ currIndex ] = size[ 3 ];
            currIndex++;
            _buffer[ currIndex ] = size[ 2 ];
            currIndex++;
            _buffer[ currIndex ] = size[ 1 ];
            currIndex++;
            _buffer[ currIndex ] = size[ 0 ];
            currIndex++;
            ...
            _buffer[ currIndex ] = 0x78;
            currIndex++;
            _buffer[ currIndex ] = 0xDA;
            currIndex++;
            ...
            _buffer[ currIndex ] = 81;
            currIndex++; // CRC
            _buffer[ currIndex ] = 189;
            currIndex++; // CRC
            _buffer[ currIndex ] = 159;
            currIndex++; // CRC
